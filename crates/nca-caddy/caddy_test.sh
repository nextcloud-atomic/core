...
for testfn in tests::{test_set_static_response,test_change_caddy_config} config::builders::tests::{test_activate_nextcloud_server,test_activate_nca_setup_server}
do
  echo "TESTING '$testfn' ..."
